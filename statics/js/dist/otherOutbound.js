...
//				},
		...
		addEvent: function() {
			...
			$(".wrapper").on("click", "#edit", function(e) {
				...
				//if (Business.verifyRight("IO_UPDATE")) {
					...
					t && Public.ajaxPost(invoi_outedit, {
		...
		//		LODOP.SET_SHOW_MODE("MESSAGE_PARSING_URL","");//该语句隐藏进度条或修改提示信息
			...
			$("#prev").click(function(t) {
				...
				Public.ajaxGet(invoi_info+"?type=2", {
	...
	hasLoaded = !1,
	originalData;
if (urlParam.id) hasLoaded || Public.ajaxGet(invoi_info+"?type=2", {			
