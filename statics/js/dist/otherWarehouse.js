...
//					})
			...
			if (e.id > 0) {
				...
				this.$_toolBottom.html("edit" === e.status ? '<a id="add" class="ui-btn ui-btn-sp mrb">' + common_add + '</a><a id="edit" class="ui-btn mrb">保存</a><a href="#"  id="print"  rel="'+ e.id +'" class="ui-btn">打印</a>' : '<a id="add" class="ui-btn ui-btn-sp mrb">' + common_add + '</a><a href="#"  id="print"  rel="'+ e.id +'" class="ui-btn">打印</a><a class="ui-btn-prev mrb" id="prev" title="上一张"><b></b></a><a class="ui-btn-next" id="next" title="下一张"><b></b></a>');
				...
				if (i) {
					...
					Public.ajaxPost(invoi_in, {
						...
						if (200 === t.status) {
							...
							e.$_toolBottom.html('<a id="add" class="ui-btn ui-btn-sp mrb">' + common_add + '</a><a id="edit" class="ui-btn mrb">保存</a><a href="/scm/invOi.do?action=toOiPdf&id=' + originalData.id + '" target="_blank" id="print" class="ui-btn">打印</a>');
							parent.Public.tips({
								content: "保存成功！"
							})
