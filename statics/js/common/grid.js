!function ($) {
	...
	$.extend($.jgrid, {
		...
		parseDate: function (e, t, i, r) {
			...
			s,
			n,
			o = /\\.|[dDjlNSwzWFmMntLoYyaABgGhHisueIOPTZcrU]/g,
		...
		getXmlData: function (e, t, i) {
			...
			if ("function" == typeof t)
				return t(e);
			if (a && a[2])
				return a[1] ? $(a[1], e).attr(a[2]) : $(e).attr(a[2]);
			r = $(t, e);
		...
		from: function (source) {
			var QueryObject = function (d, q) {
				...
				this._compare = function (e, t, i) {
					...
					if (null !== e && null === t)
						return  - 1;
					if ("[object Date]" === r.call(e) && "[object Date]" === r.call(t))
				...
				this._doSort = function (e, t) {
					...
					if (t === _sorting.length - 1)
						return self._getOrder(e, i, r, a, s, n);
					t++;
					var o,
					l,
					d,
					c = self._getGroup(e, i, r, a, s),
					u = [];
				...
				this._getOrder = function (e, t, i, r, a, s) {
					...
					p = "a" === i ? 1 :  - 1;
					void 0 === r && (r = "text");
					d = "float" === r || "number" === r || "currency" === r || "numeric" === r ? function (e) {
					...
					u.sort($.isFunction(s) ? function (e, t) {
						e = e.vSort;
						t = t.vSort;
				...
				this.startsWith = function (e, t) {
					...
					if (_useProperties)
						self._append(self._getStr("jQuery.jgrid.getAccessor(this,'" + e + "')") + ".substr(0," + r + ") == " + self._getStr('"' + self._toStr(t) + '"'));
					else {
				...
				r = {
					...
					populateVisible: function () {
						...
						if (e) {
							...
							if (a) {
								...
								if (l) {
									if (t.lastpage && (o > t.lastpage || 1 === t.lastpage || o === t.page && o === t.lastpage))
										return;
									if (r.hDiv.loading)
					...
					selectionPreserver: function (e) {
						...
						s = function () {
							...
							t.selrow = null;
							t.selarrrow = [];
							if (t.multiselect && r && r.length > 0)
								for (n = 0; n < r.length; n++)
									r[n] !== i && $(e).jqGrid("setSelection", r[n], !1, null);
					...
					if (void 0 !== document.documentMode && document.documentMode <= 5)
						...
						if (this.p.colNames.length === this.p.colModel.length) {
							...
							y = function (e) {
								...
								if ("delete" === e) {
									var n = 0;
									for (var o in i.p._index)
										i.p._index.hasOwnProperty(o) && (i.p._index[o] = n++)
								} else
									for (r = 0; s > r; r++) {
							...
							N = function (e, t, r, a, s) {
								...
								if ($.isXMLDoc(e)) {
									...
									k =  - 1 === String(D).indexOf("[") ? q.length ? function (e, t) {
										return $(D, e).text() || t
									}
									 : function (e, t) {
									...
									$.isFunction(d.userdata) ? i.p.userData = d.userdata.call(i, e) || {}
									 : $.jgrid.getXmlData(e, d.userdata, !0).each(function () {
									...
									if (M && G) {
										s && (B *= s + 1);
										var Y,
										U = $.isFunction(i.p.afterInsertRow),
										V = !1;
										if (i.p.grouping) {
									...
									if (i.p.gridview === !0) {
										...
										if (i.p.grouping) {
											...
											i.p.treeGrid === !0 && h > 0 ? $(i.rows[h]).after(A.join("")) : $("tbody:first", t).append(A.join(""))
									}
									if (i.p.subGrid === !0)
										try {
							...
							D = function (e, t, r, a, s) {
								...
								if (e) {
									...
									var V,
									K = $.isFunction(i.p.afterInsertRow),
									X = [],
									Q = !1;
									if (i.p.grouping) {
									...
									if (i.p.gridview === !0) {
										...
										if (i.p.grouping) {
											...
											i.p.treeGrid === !0 && I > 0 ? $(i.rows[I]).after(G.join("")) : $("#" + $.jgrid.jqID(i.p.id) + " tbody:first").append(G.join(""))
									}
									if (i.p.subGrid === !0)
										try {
									...
									if (u) {
										for (; _ > F && x[F]; ) {
											...
											if (N) {
												...
												for (y = 0; y < k.length; y++)
													O[i.p.colModel[y + q + P + A].name] = $.jgrid.getAccessor(N, k[y]);
												O[d] = $.jgrid.stripPref(i.p.idPrefix, T);
							...
							k = function () {
								...
								if ($.isArray(i.p.data)) {
									var u,
									p,
									h = i.p.grouping ? i.p.groupingView : !1;
									$.each(i.p.colModel, function () {
										...
										if (i.p.grouping)
											for (p = 0, u = h.groupField.length; u > p; p++)
												if (this.name === h.groupField[p]) {
													var e = this.name;
									...
									if (!i.p.treeGrid) {
										...
										if (i.p.grouping)
											for (p = 0; u > p; p++)
												g.orderBy(c[p], h.groupOrder[p], d[p].stype, d[p].srcfmt);
										...
										if ((i.p.search || i.p.resetsearch) && i.p.grouping && i.p.groupingView._locgr) {
											...
											_,
											x,
											j = $.jgrid.getMethod("groupingPrepare");
											if (i.p.footerrow && i.p.userDataOnFooter) {
												for (_ in i.p.userData)
													i.p.userData.hasOwnProperty(_) && (i.p.userData[_] = 0);
												x = !0
											}
											for (k = 0; y > k; k++) {
												if (x)
													for (_ in i.p.userData)
														i.p.userData[_] += parseFloat(b[k][_] || 0);
												j.call($(i), b[k], k, w)
											}
										}
										b = b.slice((C - 1) * w, C * w);
							...
							_ = function (e, t) {
								...
								if (p) {
									...
									if (i.p.viewrecords)
										if (0 === i.p.reccount)
											$(".ui-paging-info", p).html(i.p.emptyrecords);
										else {
											n = s + 1;
											l = i.p.records;
											if ($.fmatter) {
							...
							I = function (e) {
								if (!i.grid.hDiv.loading) {
									...
									if (e > 1)
										...
										null !== n.npage && delete i.p.postData[n.npage];
									if (i.p.grouping) {
									...
									case "script":
										$.ajax($.extend({
												...
												success: function (r, s, n) {
													if ($.isFunction(i.p.beforeProcessing) && i.p.beforeProcessing.call(i, r, s, n) === !1)
														j();
													else {
							...
							S = function (e, t) {
								...
								d,
								u,
								p = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>",
								h = "",
								...
								if (i.p.colModel[t].sortable && !(i.p.savedRow.length > 0)) {
									...
									if ("stop" !== $(i).triggerHandler("jqGridSortCol", [i.p.sortname, t, i.p.sortorder]))
										if ($.isFunction(i.p.onSortCol) && "stop" === i.p.onSortCol.call(i, i.p.sortname, t, i.p.sortorder))
											...
											if ("local" === i.p.datatype)
												i.p.deselectAfterSort && $(i).jqGrid("resetSelection");
											else {
												i.p.selrow = null;
												i.p.multiselect && T(!1);
												i.p.selarrrow = [];
							...
							this.p.id = this.id;
							 - 1 === $.inArray(i.p.multikey, d) && (i.p.multikey = !1);
							i.p.keyName = !1;
							...
							U,
							V,
							K = "<thead><tr class='ui-jqgrid-labels' role='rowheader'>",
							X = "",
							Q = "",
							Z = [],
							J = [],
							...
							$(i).before(r.hDiv).click(function (e) {
								...
								if (0 === $(Y).length || Y[0].className.indexOf("ui-state-disabled") >  - 1 || ($(W, i).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== i.id)
									return this;
							...
							if (i.p.toolbar[0]) {
								...
								if ("both" === i.p.toolbar[1]) {
									...
									$(r.uDiv).width(r.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id);
								ct && $(r.uDiv).hide()
							}
							if (i.p.toppager) {
							...
							if (i.p.caption) {
								...
								if (i.p.hidegrid === !0) {
									$(".ui-jqgrid-titlebar-close", r.cDiv).click(function (e) {
										var t,
										a = $.isFunction(i.p.onHeaderClick),
	...
	$.jgrid.extend({
				...
				for (; i > s; ) {
					...
					if ($(o).hasClass("jqgrow")) {
						$('td[role="gridcell"]', o).each(function (e) {
							...
							if ("cb" !== n && "subgrid" !== n && "rn" !== n)
								if (l.p.treeGrid === !0 && n === l.p.ExpandColumn)
									r[n] = $.jgrid.htmlDecode($("span:first", this).html());
								else
									try {
		...
		delRowData: function (e) {
			...
			this.each(function () {
				...
				a = !0;
				if (s.p.multiselect) {
					i = $.inArray(e, s.p.selarrrow);
					 - 1 !== i && s.p.selarrrow.splice(i, 1)
				}
				...
				if (t)
					try {
						...
						if ("local" === l.p.datatype) {
							var u,
							p = $.jgrid.stripPref(l.p.idPrefix, e),
							h = l.p._index[p];
							if (l.p.treeGrid)
								for (u in l.p.treeReader)
									l.p.treeReader.hasOwnProperty(u) && delete c[l.p.treeReader[u]];
			...
			if (t) {
				...
				this.each(function () {
					...
					for (var N = 0, D = "", k = {}, _ = $.isFunction(y.p.afterInsertRow) ? !0 : !1; C > N; ) {
						...
						s[s.length] = "</tr>";
						if (0 === y.rows.length)
							$("table:first", y.grid.bDiv).append(s.join(""));
						else
							switch (i) {
							case "last":
			...
			this.each(function () {
				...
				$(this.p.colModel).each(function (r) {
					...
					if ("set" === e) {
						...
						"get" === e && (o[a] = $("tr.footrow td:eq(" + r + ")", d.grid.sDiv).html())
				})
			});
			return "get" === e ? o : n
		},
				...
				if (r.grid) {
					...
					$(this.p.colModel).each(function (o) {
						if ( - 1 !== $.inArray(this.name, e) && this.hidden === n) {
							if (r.p.frozenColumns === !0 && this.frozen === !0)
								return !0;
			...
			return this.each(function () {
				...
				if (!this.ftoolbar) {
					...
					s = function (r) {
						...
						e.each(i.p.colModel, function () {
							var t,
							r = e("#gs_" + e.jgrid.jqID(this.name), this.frozen === !0 && i.p.frozenColumns === !0 ? i.grid.fhDiv : i.grid.hDiv);
					...
					n = function (r, s, o) {
						...
						s = parseInt(s, 10);
						o = parseInt(o, 10) + 18;
						for (var n, l, d = e(".ui-jqgrid-view").css("font-size") || "11px", c = '<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="font-size:' + d + ";left:" + s + "px;top:" + o + 'px;">', u = e(r).attr("soper"), p = [], h = 0, f = e(r).attr("colname"), g = i.p.colModel.length; g > h && i.p.colModel[h].name !== f; )
							h++;
					...
					e.each(i.p.colModel, function (s) {
						...
						if (this.search) {
							...
							case "custom":
								...
								e(m).append(v);
								try {
									if (!e.isFunction(o.custom_element))
										throw "e1";
...
!function (e) {
	...
	e.extend(e.jgrid, {
		...
		checkDate: function (e, t) {
			...
			u = a[e[n]].toString();
			2 === s && 1 === u.length && (s = 1);
			if (u.length !== s || 0 === a[e[n]] && "00" !== t[n])
				return !1;
			if ( - 1 === d)
				return !1;
			u = a[e[d]].toString();
			if (u.length < 1 || a[e[d]] < 1 || a[e[d]] > 12)
				return !1;
			if ( - 1 === l)
				return !1;
			u = a[e[l]].toString();
		...
		checkValues: function (t, i, r, a) {
			...
			if (s) {
				...
				if (s.required === !0 && e.jgrid.isEmpty(t))
					return [!1, n + ": " + e.jgrid.edit.msg.required, ""];
				var p = s.required === !1 ? !1 : !0;
				if (s.number === !0 && (p !== !1 || !e.jgrid.isEmpty(t)) && isNaN(t))
					return [!1, n + ": " + e.jgrid.edit.msg.number, ""];
				if (void 0 !== s.minValue && !isNaN(s.minValue) && parseFloat(t) < parseFloat(s.minValue))
					return [!1, n + ": " + e.jgrid.edit.msg.minValue + " " + s.minValue, ""];
				if (void 0 !== s.maxValue && !isNaN(s.maxValue) && parseFloat(t) > parseFloat(s.maxValue))
					return [!1, n + ": " + e.jgrid.edit.msg.maxValue + " " + s.maxValue, ""];
				var h;
				...
				if (s.date === !0 && (p !== !1 || !e.jgrid.isEmpty(t))) {
					if (u[i].formatoptions && u[i].formatoptions.newformat) {
						...
						l = u[i].datefmt || "Y-m-d";
					if (!e.jgrid.checkDate(l, t))
						return [!1, n + ": " + e.jgrid.edit.msg.date + " - " + l, ""]
				}
				if (s.time === !0 && !(p === !1 && e.jgrid.isEmpty(t) || e.jgrid.checkTime(t)))
					return [!1, n + ": " + e.jgrid.edit.msg.date + " - hh:mm (am/pm)", ""];
		...
		GridNav: function () {
			return this.each(function () {
				...
				function i(e, t) {
					...
					if ("rgt" === t) {
						i = e - 1;
						for (a = e; a < r.p.colModel.length; a++)
							if (r.p.colModel[a].hidden !== !0) {
								i = a;
								break
							}
				...
				if (r.grid && r.p.cellEdit === !0) {
					...
					var a,
					s,
					o = e("<div style='position:fixed;top:0px;width:1px;height:1px;' tabindex='0'><div tabindex='-1' style='width:1px;height:1px;' id='" + r.p.knv + "'></div></div>");
...
!function (e) {
	...
	e.extend(e.fmatter, {
		...
		isEmpty: function (t) {
			if (!this.isString(t) && this.isValue(t))
				return !1;
			if (!this.isValue(t))
				return !0;
	...
	e.fn.fmatter.select = function (t, i) {
		...
		if (o) {
			var n,
			l = i.colModel.editoptions.multiple === !0 ? !0 : !1,
			d = [];
			if (l) {
				d = t.split(",");
			...
			if (e.fmatter.isString(o)) {
				...
				e.fmatter.isObject(o) && (l ? s = e.map(d, function (e) {
							return o[e]
						}) : s[0] = o[t] || "")
		}
		t = s.join(", ");
	...
	e.fn.fmatter.actions = function (t, i) {
		...
		if (void 0 === o || e.fmatter.isEmpty(o))
			return "";
		if (a.editformbutton) {
