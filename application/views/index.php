...
<!--          <div class="nav-item nav-fund last">
  ...
  <div id="col-main">
    <div id="main-hd" class="cf">
      ...
      <ul class="user-menu">
      	<li class="qq"><a href="http://wpa.qq.com/msgrd?v=3&uin=1159995880&site=qq&menu=yes" target="_blank">QQ咨询：1159995880</a></li>
      	<li class="space">|</li>
        
      	<li class="telphone">电话：13888888888</li>
...
//	},
	...
	puDetail: {
        ...
        puContract: {
		name: "采购合同",
		href: "<?=site_url('report/cus_contract')?>",
		dataRight: "PUREOORTDETAIL_QUERY",
		target: "report-purchase"
	},
	puSummary: {
