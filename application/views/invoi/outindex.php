  ...
  <div class="mod-search cf">
    <div class="fl">
      <ul class="ul-inline">
        ...
        <li><!--<a class="mrb more" id="moreCon">(高级搜索)</a>--><a class="ui-btn mrb" id="search"><?php echo showlang('common', 'common_query');?></a></li>
      </ul>
    </div>
    <div class="fr"><a class="ui-btn ui-btn-sp" id="add"><?php echo showlang('common', 'common_add');?></a><!--<a class="ui-btn" id="export"><?php echo showlang('common', 'common_export');?></a>--></div>
  </div>
  <div class="grid-wrap">
    <table id="grid">
    </table>
