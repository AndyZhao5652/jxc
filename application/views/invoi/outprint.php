	...
	for ($n = 1; $n <= $pages; $n++) { ?>
		<table width="690"  border="0">
		    ...
		    <tr target="id" align="center">
				<td colspan="8" height="15"><h2 style="font-size:14px">其他(出库)单</h2></td>
		    </tr>
			<tr>
				<td colspan="2" height="15">客户：<?=$contactname?></td>
			    <td colspan="2">单据日期：<?=$billdate?></td>
				<td colspan="2">单据编号：<?=$billno?></td>
				<td width="133" colspan="2" align="right">业务类型: <?=$type==3?'其他出库':'盘亏'?></td>
			</tr>
			<tr>
		...
		<table class="list" width="690">
			  ...
			  ?>
				...
				<tr target="id">
					...
					<td colspan="3" rowspan="2"  >     <span style="font-size:18px">出库人签字：</span> </td>
				</tr>
