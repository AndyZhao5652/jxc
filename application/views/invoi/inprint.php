	...
	for ($n = 1; $n <= $pages; $n++) { ?>
		<table width="690"  border="0">
		    ...
		    <tr target="id" align="center">
				<td colspan="8" height="15"><h2 style="font-size:14px">其他(入库)单</h2></td>
		    </tr>
			<tr>
				<td colspan="2" height="15">供应商：<?=$contactname?></td>
			    <td colspan="2">单据日期：<?=$billdate?></td>
				<td colspan="2">单据编号：<?=$billno?></td>
				<td width="133" colspan="2" align="right">业务类型: <?=$type==1?'其他入库':'盘盈'?></td>
			</tr>
			<tr>
		...
		<table class="list" width="690">
			  ...
			  $stt = ($n-1) * 13;    
			  $data  = array();  
			  $data  = array_slice($list,$stt,$n*13); 
			  ...
			  ?>
				<tr height="15">
					...
					<td width="180" align="center"><?=$row['goodsname']?></td>
				...
				<tr target="id">
					...
					<td colspan="2">合计金额：<?=$amount?> </td>
				</tr>
			
				<tr target="id">
				    <td colspan="4" height="10">制单：<?=$username?></td>
					<td colspan="3" rowspan="2"  >     <span style="font-size:18px">入库人签收：</span> </td>
				</tr>
				
				<tr target="id">
				    <td colspan="4" height="10">主管审批：   &nbsp;   &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; 核对：  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;      </td>
				</tr>
		</table>	
