...
//�������
//$this->load->database('default1', TRUE);  ��ʹ�õ�ҳ������
//$db['default1']['hostname'] = DB_HOST;
//$db['default1']['username'] = DB_USER;
//$db['default1']['password'] = DB_PWD;
//$db['default1']['database'] = 'qxt_rzc';
...
//$db['default1']['dbcollat'] = 'utf8_unicode_ci';
